...
def main():
    ...
    fitting_dir ='/home/miao/data/rylm/sample1/body_gen'
    ...
    for body_file in sorted(glob.glob(fitting_dir+'/*.pkl')):
        ...
        imgname= body_file.split('/')[-1].replace('.pkl','')
        write_name='./output/baseline/'+imgname+'.png'
        read_name= '/home/miao/data/rylm/sample1/images/img'+imgname+'.png'
        input_img = cv2.imread(read_name)
